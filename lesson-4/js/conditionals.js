...
function getWindSpeed() {
	...
	switch (speed) {
		...
		default:
			windComment.textContent = speed += 'No wind speed available';
	}
...
coffeeBreak ? breakMessage.textContent = "Coffe time!" : breakMessage.textContent = "Keep working.";
